    ...
    */
    ...
    $.fn.CircularCarousel = function(options) {
        ...
        var $ele = $(this),
            ...
            $bullets = $ele.find('.' + options.classNamebullet),
        ...
        */
        function positionItems(x, y, angle) {
            ...
            $bullets.eq(activeItem).addClass('active');
            ...
            while (n < cycleMax) {
                ...
                $items.eq(offsetElement).css('margin-left', Y - 45 + 'px');
        ...
        var methods = {
            ...
            */
            ...
            cycleActive: function(direction) {
                ...
                var activeElement = $items.eq(activeItem);
                var activeBullet = $bullets.eq(activeItem);
                activeElement.removeClass('active');
